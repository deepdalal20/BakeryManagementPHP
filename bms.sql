...
--
-- Host: localhost
-- Generation Time: Dec 06, 2022 at 06:58 AM
...
(39, 'Deep', 'deepdalal20@gmail.com', '$2y$10$hQyP4IlEEVQ0blg0jKWCJOMJGhoVkX5hUeGKOU/Dy84WTJ2D.CpWa', 9033921032, 313251, '2022-12-06 11:27:39');
...
--
ALTER TABLE `tblcart`
  MODIFY `crt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `tblord`
  MODIFY `ord_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
